...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="http://www.zyxm.com/Public/Admin/css/page.css" />
    </head>
    <body>
        <h1>
            <span class="action-span"><a href="<?php echo U('add');?>">添加角色</a></span>
            <span class="action-span1"><a href="#">ECSHOP 管理中心</a></span>
            <span id="search_id" class="action-span1"> - 角色管理 </span>
        </h1>
            ...
            <div class="list-div" id="listDiv">
                <table cellpadding="3" cellspacing="1">
                    ...
                    <?php if(is_array($rows)): foreach($rows as $key=>$row): ?><tr>
                            ...
                            <td align="center"><?php if($row["status"] == 1): ?><img src="http://www.zyxm.com/Public/Admin/images/yes.gif" /><?php else: ?><img src="http://www.zyxm.com/Public/Admin/images/no.gif" /><?php endif; ?></td>
                            <td align="center">
